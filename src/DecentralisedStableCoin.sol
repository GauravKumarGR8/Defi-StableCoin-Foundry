 ...
 *
 * This is the contract meant to be governed by DSCEngine. The contract is just
 * the ERC20 implementation of our stablecoin system.
 *
 */
contract DecentralisedStableCoin is ERC20Burnable, Ownable {
    ...
    address private s_initialOwner;

    constructor(address _initialOwner) ERC20("DecentralisedStableCoin", "DSC") Ownable(_initialOwner) {
        s_initialOwner = _initialOwner;
    }
